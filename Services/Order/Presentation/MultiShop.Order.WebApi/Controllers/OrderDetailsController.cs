...
using MultiShop.Order.Application.Features.CQRS.Queries.OrderDetailQueris;
...
namespace MultiShop.Order.WebApi.Controllers
{
	...
	public class OrderDetailsController : ControllerBase
	{
		...
		public async Task<IActionResult> CreateOrderDetail(CreateOrderDetailCommand command)
		{
			...
			return Ok("Sipariş Detasyı Başarıyla eklendi");
		}
		...
		public async Task<IActionResult> RemoveOrderDetail(int id)
		{
			...
			return Ok("Sipariş Detasyı başarıyla silindi");
		}
		[HttpPut]
		public async Task<IActionResult> UpdateOrderDetail(UpdateOrderDetailCommand command)
		{
			await _updateOrderDetailCommandHandler.Handle(command);
			return Ok("Sipariş Detasyı başarıyla güncellendi");
		}
	}
}
